"""
Y6CP Redundancy Equations

Ported from y6cp_redundancy.h

Y6CP redundancy uses similar patterns to Y62P but with
different geometry constants due to higher density.
...
# =============================================================================
# REDUNDANCY CONSTANTS (from y6cp_redundancy.h)
# =============================================================================

RED_ROWS_PER_BANK = 86
RED_COLS_PER_BANK = 512

# Y6CP-specific redundancy multipliers
RED_ROW_MULT = 4
RED_COL_MULT = 16

# Y6CP-specific redundancy masks
...
# =============================================================================
# ROW REPAIR EQUATIONS (from y6cp_redundancy.h)
# =============================================================================
...
def decode_row_repair(
    ...
    """
    Decode Y6CP row repair to physical coordinates.

    From y6cp_redundancy.h (y6cp_row_redun):
    // phy_row = (repaired_element & RED_ROW_MASK) * RED_ROW_MULT
    //
    // Y6CP uses RED_ROW_MULT = 4 and FULL_RED_ROW_MASK = 0x1FFFC
    ...
    # Apply Y6CP row redundancy equation
    # This is the exact equation from y6cp_redundancy.h
    ...
    # Calculate absolute physical row
...
# =============================================================================
# COLUMN REPAIR EQUATIONS (from y6cp_redundancy.h)
# =============================================================================
...
def decode_col_repair(
    ...
    """
    Decode Y6CP column repair to physical coordinates.

    From y6cp_redundancy.h (y6cp_col_redun):
    // phy_col = ((repaired_element & FULL_RED_COL_MASK) >> 4) * RED_COL_MULT
    //
    // Y6CP uses RED_COL_MULT = 16 and FULL_RED_COL_MASK = 0xFFF0
    ...
    # Apply Y6CP column redundancy equation
    # This is the exact equation from y6cp_redundancy.h
    ...
    # Calculate absolute physical column
    ...
    return ColRepairResult(
        ...
        raw={
            ...
            'equation': f'(({repaired_element} & {hex(FULL_RED_COL_MASK)}) >> 4) * {RED_COL_MULT}',
            'bx': bx,
            'by': by,
            'did': 'Y6CP',
        }
...
def generate_row_repair_overlay(
    ...
    """Generate Y6CP row repair overlay data."""
    ...
    return {
        ...
        'physical_location': {
            ...
            'column': None,
            'sec': {'sec_x': result.sec_x, 'sec_y': 0},
            'span': {
...
def generate_col_repair_overlay(
    ...
    """Generate Y6CP column repair overlay data."""
    ...
    return {
        ...
        'physical_location': {
            ...
            'sec': {'sec_x': 0, 'sec_y': result.sec_y},
            'span': {
