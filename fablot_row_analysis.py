...
detailed_table_data = """FID,STEP,SUMMARY,MSN,MFG_WORKWEEK,TEST_FACILITY,ISLATEST,PCB,MCQ,MODFF,PROCESSCODE,FID_STATUS,FID_STATUS2,MSN_STATUS,FAILCRAWLER,DRAMFAIL,ULOC,ADDRMASK,ADDRCNT,BITCNT,ROWCNT,COLCNT,DQCNT,False Failure Script
